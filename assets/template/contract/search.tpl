<div class="row">
    <div class="col-sm-4 col-md-3">
        ...
        <input type="text" value="常州市环保局" class="form-control"/>

        <div class="mb20"></div>

        <h4 class="subtitle mb5">甲方地址</h4>
        <select class="select2" data-placeholder="选择一个地址...">
            <option value=""></option>
        ...
        <h4 class="subtitle mb5">合同金额</h4>
        <div id="slider" class="slider-primary mb20"></div>

        <div class="mb20"></div>

        <h4 class="subtitle mb5">合同类型</h4>
        <ul class="nav nav-sr">
    ...
    <div class="col-sm-8 col-md-9">
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">“常州环保局”的搜索结果</h4>
                <p>大约 1,370 个结果 (0.13 秒)</p>
            </div><!-- panel-heading -->
                ...
                <div class="results-list">
                    ...
                    <div class="media">
                        <a href="#" class="pull-left">
                            <img alt="" src="/assets/images/photos/media1.jpg" class="media-object">
                        </a>
                        <div class="media-body">
                            <h4 class="filename text-primary">Pizza.png</h4>
                            <small class="text-muted">Type: JPG Image</small>
                            <br/>
                    ...
                    <div class="media">
                        <a href="#" class="pull-left">
                            <img alt="" src="/assets/images/photos/media3.png" class="media-object">
                        </a>
                        <div class="media-body">
                            <h4 class="filename text-primary">Painting.mp4</h4>
                            <small class="text-muted">Type: MP4 Video</small>
                            <br/>
                            <small class="text-muted">Created: January 13, 2014 at 7:30am</small>
                            <br/>
                            <small class="text-muted">Modified: January 13, 2014 at 11:30am</small>
